...
<div class="site-width">
  ...
  <div class="elsewhere-links">
    ...
    <a href="https://github.com/malabooboo" class="link-github link-icon" title="Malabooboo on Github">
    ...
    <a href="https://instagram.com/malabooboo" class="link-instagram link-icon" title="Malabooboo on Instagram">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#fff">
